<template>
    <div aria-labelledby="recommendations-title">
        
        <!-- Chargement de recommandations -->
        <div v-if="loading" aria-busy="true">
            <Loading fillColor="fill-secondary" />
        </div>

        <div v-else class="flex flex-col justify-center items-center" aria-busy="false" aria-live="polite">
            <!-- Carrousel principal -->
            <Carousel 
                :items-to-show="3" 
                :transition="500"
            ...
            >
                <Slide v-for="(recommendation, index) in recommendations" :key="recommendation.id">
                    <div class="flex items-center justify-center h-52 cursor-pointer" @click="slideTo(index)">
                        <img :src="recommendation.avatar" :alt="'Photo de ' + recommendation.name" 
            ...
            <div class="md:grid md:grid-cols-3 md:mt-5 mt-0 flex justify-center gap-10 items-center">
                ...
                <div class="md:col-span-2 lg:col-span-1 text-center relative flex justify-center items-center sm:ps-0 ps-5">
                    <div :key="activeRecommendation.id">
                ...
                <!-- Bouton de navigation pour les recommandations -->
                <div class="md:col-span-1 flex items-center justify-start sm:ps-6">
                    <button @click="slideTo(currentSlide + 1)" aria-label="Voir la prochaine recommandation">
            ...
            <!-- Contexte du carrousel pour les écrans larges -->
            ...
            <!-- Recommandation active pour petits écrans -->
