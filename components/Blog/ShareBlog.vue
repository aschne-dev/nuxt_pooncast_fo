...
const currentBlog = computed(() => blogStore.blogById(idBlog.value));

// Utilisation d'une ref pour permettre la modification de headerText
const headerText = ref('');

// Mettre à jour headerText en fonction du Blog sélectionné
...
const shareText = computed(() => encodeURIComponent(`Découvrez : ${currentBlog.value.title}`));
